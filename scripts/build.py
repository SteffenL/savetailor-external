...
TARGETS = (
    Target(name="zlib",
           ...
           url="gs://{bucket}/libraries/zlib/{version}/{filename}",
           configure_options=()),
    Target(name="boost",
           version="1.90.0",
           ...
           url="gs://{bucket}/libraries/boost/{version}/{filename}",
           configure_options=()),
    Target(name="msgpack",
           version="7.0.0",
           ...
           url="gs://{bucket}/libraries/msgpack/{version}/{filename}",
           configure_options=(
                "-DMSGPACK_CXX20=ON",
    ...
    Target(name="wxwidgets",
           ...
           url="gs://{bucket}/libraries/wxwidgets/{version}/{filename}",
           configure_options=(
               "-DwxBUILD_SHARED=" +
                   to_cmake_option_value(should_build_shared_libs()),
    ...
    Target(name="steamworks-sdk",
           ...
           source_subdir="sdk",
           url="gs://{bucket}/libraries/steamworks-sdk/{version}/{filename}",
           configure_options=(),
           configure=False,
           build=False,
    ...
    Target(name="rapidcsv",
           version="8.92",
           sha256="054f96336fc524dd5e99e3e0a5efc700c4db4692e88da33ed3e8929abcdcf9e6",
           filename="v{version}.tar.gz",
           source_subdir="rapidcsv-{version}",
           url="gs://{bucket}/libraries/rapidcsv/{version}/{filename}",
           configure_options=(
